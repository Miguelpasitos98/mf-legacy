        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/20 bg-black/10 shadow-2xl">
          ...
          {countryMapUrl && (
            <img
              ...
              alt=""
              aria-hidden="true"
              className="pointer-events-none absolute bottom-10 right-4 z-0 h-[70%] w-auto max-w-[55%] object-contain opacity-50 grayscale"
            />
          )}
          {countryTeamMapUrl && (
            <img
              ...
              alt=""
              aria-hidden="true"
              className="pointer-events-none absolute bottom-10 right-4 z-0 h-[70%] w-auto max-w-[55%] object-contain"
            />
          )}
